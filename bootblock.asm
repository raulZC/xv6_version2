...
readseg(uchar* pa, uint count, uint offset)
{
    ...
    7d03:	8b 7d 08             	mov    0x8(%ebp),%edi
    7d06:	8b 5d 10             	mov    0x10(%ebp),%ebx
  uchar* epa;

  epa = pa + count;
    7d09:	8b 75 0c             	mov    0xc(%ebp),%esi
    7d0c:	01 fe                	add    %edi,%esi

  // Round down to sector boundary.
  pa -= offset % SECTSIZE;
    7d0e:	89 d8                	mov    %ebx,%eax
    7d10:	25 ff 01 00 00       	and    $0x1ff,%eax
    7d15:	29 c7                	sub    %eax,%edi

  // Translate from bytes to sectors; kernel starts at sector 1.
  offset = (offset / SECTSIZE) + 1;
    7d17:	c1 eb 09             	shr    $0x9,%ebx
    7d1a:	43                   	inc    %ebx
  ...
  for(; pa < epa; pa += SECTSIZE, offset++)
    ...
    7d21:	53                   	push   %ebx
    7d22:	57                   	push   %edi
    7d23:	e8 68 ff ff ff       	call   7c90 <readsect>
  for(; pa < epa; pa += SECTSIZE, offset++)
    7d28:	81 c7 00 02 00 00    	add    $0x200,%edi
    7d2e:	43                   	inc    %ebx
